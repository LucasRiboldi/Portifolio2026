...
![THWIP](https://img.shields.io/badge/THWIP!-ff2d95?style=for-the-badge&labelColor=000000)
![POW](https://img.shields.io/badge/POW!-00e5ff?style=for-the-badge&labelColor=000000)
![ZAP](https://img.shields.io/badge/ZAP!-ffe600?style=for-the-badge&labelColor=000000)
![BAM](https://img.shields.io/badge/BAM!-b6ff00?style=for-the-badge&labelColor=000000)
![WHAM](https://img.shields.io/badge/WHAM!-7b2ff7?style=for-the-badge&labelColor=000000)
...
[![Next.js](https://img.shields.io/badge/Next.js_15-000000?style=flat-square&logo=next.js)](https://nextjs.org)
...
```
    ╔═══════════════════════════════════════════════╗
    ║   " CADA TELA É UMA INTERFACE,                 ║
    ║     UMA PÁGINA DE QUADRINHO,                   ║
    ║     UM PÔSTER ILUSTRADO E UM FRAME. "          ║
    ╚═══════════════════════════════════════════════╝
```
...
| | Cor | Hex | Papel |
|---|---|---|---|
| 🩷 | Magenta | `#ff2d95` | Primária |
| 🩵 | Cyan | `#00e5ff` | Secundária |
| 💛 | Yellow | `#ffe600` | Warning / destaque |
| 💚 | Lime | `#b6ff00` | Success |
...
Construído em **5 fases + Lab**, do token ao delírio:

- 🧬 **Foundations** — marca, cores, tipografia, **grid**, espaçamento, radius, sombras, ícones, texturas
- ⚛️ **Design Tokens** — CSS vars + TS tipado + export **Figma (Tokens Studio)** e **W3C DTCG**
- 🧩 **40+ Componentes** — botões, inputs (com máscaras BR!), seleção, overlays, feedback, data display, utilitários
- 🧱 **Seções & Templates** — landing, pricing, dashboard, changelog, coming-soon, docs…
- 🔀 **Patterns** — login, busca, multi-step, FAQ
- 🎭 **Direção de arte** — camada `.art-*` (texturas, halftones, contornos, sombras desenhadas) + `.fx-*` (glitch, holo, neon, VHS, spray, ransom)
- ⚡ **21 motions**, **20 ícones próprios**, **14+ ilustrações**, **10 logos**
...
[![GitHub](https://img.shields.io/badge/GitHub-LucasRiboldi-ff2d95?style=for-the-badge&logo=github&logoColor=white&labelColor=000000)](https://github.com/LucasRiboldi)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-lucasriboldi-00e5ff?style=for-the-badge&logo=linkedin&logoColor=white&labelColor=000000)](https://linkedin.com/in/lucasriboldi)
[![Email](https://img.shields.io/badge/Email-say_hi-ffe600?style=for-the-badge&logo=gmail&logoColor=black&labelColor=000000)](mailto:lucasriboldi.dev@gmail.com)

<br/>

**⚡ Feito à mão na Terra-2026 · © 2026 Lucas Riboldi ⚡**

`( com Next.js, muito halftone e zero templates limpos )`
