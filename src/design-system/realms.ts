...
const creative: RealmDesign = {
  ...
  kit: [
    ...
    {
      group: "Comic FX — títulos (.kfx-*)",
      items: [
        { name: ".kfx-outline · -double · -shadow-*", className: "kfx-outline", note: "Contorno e sombra de capa." },
        { name: ".kfx-3d · -chrome · -gold · -retro-gold", className: "kfx-3d", note: "Extrusão e metais." },
        { name: ".kfx-neon · -hud · -neon-anim", className: "kfx-neon", note: "Neon; -anim pulsa (reduz com reduced-motion)." },
        { name: ".kfx-glitch · -offset · -doubleexpose", className: "kfx-glitch", note: "Datamosh; glitch precisa de data-text." },
        { name: ".kfx-drip · -melt · -brush · -whitebrush · -crown", className: "kfx-brush", note: "Tinta e pincel." },
        { name: ".kfx-pixel · -halftone · -web · -holo · -burst · -sparks", className: "kfx-holo", note: "Texturas e efeitos; -holo anima." },
      ],
    },
    {
      group: "Web kit 8-bit (.bit-*)",
      items: [
        { name: ".bit-window · .bit-panel · .bit-corners", className: "bit-panel", note: "Janela, painel e canto serrilhado." },
        { name: ".bit-btn · .bit-badge · .bit-input", className: "bit-btn", note: "Botão com afundar, badge e campo." },
        { name: ".bit-progress · .bit-menu · .bit-dialog", className: "bit-menu", note: "Barra, menu de pause e diálogo RPG." },
        { name: ".bit-inventory · .bit-slot · .bit-score", className: "bit-slot", note: "Inventário e placar high-score." },
        { name: ".bit-ico--coin/star/mushroom/key/potion", className: "bit-ico", note: "Ícones pixel em CSS." },
        { name: ".bit-toggle · .bit-check · .bit-radio · .bit-balloon", className: "bit-toggle", note: "Controles e balão de fala." },
      ],
    },
  ],
