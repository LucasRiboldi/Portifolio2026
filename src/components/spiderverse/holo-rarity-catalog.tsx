...
const CATALOGO: Entrada[] = [
  {
    ...
    cartas: [
      { img: `${P}/33_hires.avif`, name: "Squirtle", rarity: "common", label: "Comum", desc: "Só tilt e glare" },
      { img: `${P}/116_hires.avif`, name: "Morpeko", rarity: "common", label: "Incomum", desc: "Arte texturizada, sem foil" },
    ],
  },
  {
    titulo: "Reverse holo",
    ...
    cartas: [
      { img: `${P}/49_hires.avif`, name: "Pikachu", rarity: "reverse holo", label: "Reverse holo", desc: "Foil no fundo, arte fosca" },
    ],
  },
  {
    ...
    cartas: [
      { img: `${P}/85_hires.avif`, name: "Dedenne", rarity: "reverse holo", label: "Pokémon básico", desc: "recorte de Pokémon", subtypes: "basic" },
      { img: `${P}/150_hires.avif`, name: "Ultra Ball", rarity: "reverse holo", label: "Treinador · Item", desc: "janela mais baixa", supertype: "trainer", subtypes: "item" },
      { img: `${P}/173_hires.avif`, name: "Poké Kid", rarity: "reverse holo", label: "Treinador · Supporter", desc: "mesma janela de Treinador", supertype: "trainer", subtypes: "supporter" },
      { img: `${P}/68_hires.avif`, name: "PokéStop", rarity: "reverse holo", label: "Treinador · Stadium", desc: "mesma janela de Treinador", supertype: "trainer", subtypes: "stadium" },
    ],
  },
  {
    ...
    cartas: [
      { img: `${P}/29_hires.avif`, name: "Zapdos", rarity: "rare holo", label: "Holo", desc: "Barras verticais + arco-íris" },
    ],
  },
  {
    ...
    cartas: [
      { img: `${P}/SWSH012_hires.avif`, name: "Morpeko", rarity: "rare holo cosmos", label: "Cosmos", desc: "Galáxia em três camadas", vars: { "--cosmosbg": "286px 232px" } },
    ],
  },
  {
    titulo: "Amazing rare",
    ...
    cartas: [
      { img: `${P}/21_hires.avif`, name: "Kyogre", rarity: "amazing rare", label: "Amazing rare", desc: "Explosão além da moldura" },
      { img: `${P}/82_hires.avif`, name: "Zacian", rarity: "amazing rare", label: "Amazing rare", desc: "Foil que vaza da arte" },
    ],
  },
  {
    titulo: "Radiant",
    ...
    cartas: [
      { img: `${P}/59_hires.avif`, name: "Radiant Alakazam", rarity: "radiant rare", label: "Radiant", desc: "Cross-hatch metálico" },
    ],
  },
  {
    titulo: "Pokémon V",
    ...
    cartas: [
      { img: `${P}/138_hires.avif`, name: "Lugia V", rarity: "rare holo v", label: "V", desc: "Diagonais em sentidos opostos", foil: `${P}/138_foil_holo_sunpillar_2x.webp` },
    ],
  },
  {
    ...
    cartas: [
      { img: `${P}/250_hires.avif`, name: "Mew V", rarity: "rare ultra", label: "Full art", desc: "Gravação + brilho", foil: `${P}/250_foil_etched_sunpillar_2x.webp` },
      { img: `${P}/SWSH181_hires.avif`, name: "Vaporeon V", rarity: "rare ultra", label: "Alt art", desc: "Mesmo efeito, outro foil", foil: `${P}/181_foil_etched_sunpillar_2x.webp` },
      { img: `${P}/176_hires.avif`, name: "Unown V", rarity: "rare ultra", label: "Full art", desc: "Foil derivado do nome do arquivo" },
      { img: `${P}/186_hires.avif`, name: "Giratina V", rarity: "rare ultra", label: "Alt art", desc: "Textura densa sobre a ilustração" },
    ],
  },
  {
    titulo: "Shiny Vault",
    ...
    cartas: [
      { img: `${P}/SV023_hires.avif`, name: "Galarian Darumaka", rarity: "rare shiny", label: "Shiny · básico", desc: "Prata sobre fundo branco", subtypes: "basic" },
      { img: `${P}/SV094_hires.avif`, name: "Cinccino", rarity: "rare shiny", label: "Shiny · estágio 1", desc: "Moldura de evolução", subtypes: "stage1" },
      { img: `${P}/SV110_hires.avif`, name: "Lapras V", rarity: "rare shiny v", label: "Shiny V", desc: "Prata + faixas da V" },
    ],
  },
  {
    titulo: "VMAX",
    ...
    cartas: [
      { img: `${P}/271_hires.avif`, name: "Gengar VMAX", rarity: "rare holo vmax", label: "VMAX alt", desc: "Foil amplo e lento", subtypes: "vmax", foil: `${P}/271_foil_etched_swsecret_2x.webp` },
    ],
  },
  {
    titulo: "Secreta (ouro)",
    ...
    cartas: [
      { img: `${P}/160_hires.avif`, name: "Pikachu", rarity: "rare secret", label: "Secreta", desc: "Dois glitters cruzados", foil: `${P}/160_foil_etched_swsecret_2x.webp` },
    ],
  },
  {
    ...
    cartas: [
      { img: `${P}/TG05_hires.avif`, name: "Pikachu & Akari", rarity: "trainer gallery rare holo", label: "Trainer gallery", desc: "Aquarela holográfica", trainerGallery: true, foil: `${P}/tg05_foil_holo_rainbow_2x.webp` },
      { img: `${P}/TG17_hires.avif`, name: "Pikachu VMAX", rarity: "rare holo vmax", label: "TG VMAX", desc: "V/VMAX com outra textura", subtypes: "vmax", trainerGallery: true, foil: `${P}/tg17_foil_etched_sunpillar_2x.webp` },
      { img: `${P}/TG16_hires.avif`, name: "Mimikyu V", rarity: "rare ultra", label: "TG V", desc: "V da galeria de treinadores", trainerGallery: true },
      { img: `${P}/TG26_hires.avif`, name: "Kabu", rarity: "rare ultra", label: "TG Supporter", desc: "Treinador em arte completa", supertype: "trainer", subtypes: "supporter", trainerGallery: true },
    ],
  },
]
