...
export function FeedbackContent({ headingAs = "h1" }: { headingAs?: "h1" | "h2" }) {
  return (
    <SvToaster>
      <FeedbackInner headingAs={headingAs} />
    </SvToaster>
  )
}

function FeedbackInner({ headingAs }: { headingAs: "h1" | "h2" }) {
  ...
  return (
    <div>
      ...
      <ComicHeader as={headingAs} kicker="04 · Feedback" title="O sistema" highlight="fala" />
