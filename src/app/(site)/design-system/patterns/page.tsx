          ...
          <DsCard key={p.name}>
            <div className="flex items-center justify-between gap-2">
              ...
              <div className="flex items-center gap-2">
                {p.href && (
                  <Link href={p.href} className="inline-flex items-center gap-1 rounded border-2 border-[var(--sv-cyan)] px-1.5 py-0.5 text-[0.65rem] font-bold uppercase tracking-wide text-[var(--sv-cyan)] transition-colors hover:bg-[var(--sv-cyan)] hover:text-black">
