...
/**
 * Person + WebSite (schema.org) da home. Escopo deliberadamente restrito ao
 * site como um todo — canonical por rota exigiria metadata em cada uma das
 * ~80 páginas, e um canonical "global" apontando tudo para a home seria pior
 * que nenhum (diria ao Google que todo o site é duplicata da home). Ver
 * NEXT_STEPS.md item 18.
 */
function structuredData(site: { name: string; description: string; github: string }) {
  return {
